...
use app\findcolortwo\model\ShareGroup;
use app\findcolortwo\model\UserGame;
use app\findcolortwo\model\Users;
    ...
    public function begin_challenge()
    {
        ...
        if ($user_game) {
            if ($user_game['chance_num'] <= 0) {
                return ['code' => 400, 'msg' => '挑战次数为空'];
            }
            Db::name('user_game')->where(array('uid' => $user_id))->setDec('chance_num');
