...
class Questions extends Model
{
    ...
    public function get_questions($expire = 86200)
    {
        ...
        if (!$question) {
            $question[] = db('questions')->where(array('level' => 1))->field('id,option_1,option_2,level')->select();
            $question[] = db('questions')->where(array('level' => 2))->field('id,option_1,option_2,level')->select();
            $question[] = db('questions')->where(array('level' => 3))->field('id,option_1,option_2,level')->select();
            $question[] = db('questions')->where(array('level' => 4))->field('id,option_1,option_2,level')->select();
