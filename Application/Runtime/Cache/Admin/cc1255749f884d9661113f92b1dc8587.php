		...
		<form class="form form-horizontal" id="form-admin-add" enctype="multipart/form-data">
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-6">
					<input type="text" class="input-text" value="<?php echo ($app["name"]); ?>" placeholder="" name="name">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>描述：</label>
				<div class="formControls col-xs-8 col-sm-6">
					<input type="text" class="input-text" value="<?php echo ($app["desc"]); ?>" placeholder="" name="desc">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>AppID：</label>
				<div class="formControls col-xs-8 col-sm-6">
					<input type="text" class="input-text" value="<?php echo ($app["appid"]); ?>" placeholder="<?php echo ($app["appid"]); ?>" readonly="readonly">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>排序：</label>
				<div class="formControls col-xs-4 col-sm-6">
					<input type="text" class="input-text" value="<?php echo ($app["sort"]); ?>" placeholder="" name="sort">
				</div>
			</div>
			...
			<div class="row cl">
				...
				<img width="50px" height="50px" src="<?php echo ($app["logo"]); ?>">
			</div>
			<div class="row cl">
				...
				<select class="select" size="1" name="type">
					...
					<?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t_vo): $mod = ($i % 2 );++$i; if(($app["type"]) == $t_vo["id"]): ?><option value="<?php echo ($t_vo["id"]); ?>" selected><?php echo ($t_vo["name"]); ?></option>
						<?php else: ?>
							<option value="<?php echo ($t_vo["id"]); ?>" ><?php echo ($t_vo["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
				</select>
				</span> </div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9 skin-minimal">
					<?php if(($app["status"]) == "1"): ?><div class="radio-box">
			...
			<input type="hidden" value="<?php echo ($app["id"]); ?>" name="id">
			<div class="row cl">
...
$(function(){
	...
	$("#form-admin-add").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				type: 'post',
				url: "<?php echo U('Admin/App/do_edit');?>" ,
