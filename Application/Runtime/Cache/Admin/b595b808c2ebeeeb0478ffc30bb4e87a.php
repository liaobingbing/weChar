...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">快鱼后台</a><a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A"> <?php echo session('admin_username');?> <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
							<li><a href="<?php echo U('Admin/Admin/logout');?>">切换账户</a></li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl >
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('Admin/Song/song_list');?>" data-title="曲库管理" href="javascript:void(0)">曲库管理</a></li>
				</ul>
				<ul>
