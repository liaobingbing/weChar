...
class ApiController extends ApiBaseController{
    ...
    public function get_question(){
        ...
        if($user_game){
            ...
            $idiom=M('answer')->where('status=1 and layer=%d',$layer)->cache(86400)->find();
            if($idiom){
                    ...
                    if($u_answer==$idiom['answer']){
                        ...
                        if($type==1){
                            ...
                            if($recommend_user_id){
                                $has=M('user_help')->where('uid=%d and help_user=%d and layer=%d',$recommend_user_id,$user_game['uid'],$layer)->find();
                                $info2=true;
                                if(!$has){
    ...
    public function get_layer(){
        ...
        if($user_game){
            ...
            if($level_id){
                ...
                $level_arr=M('level')->where('status=1 and id=%d',$level_id)->cache(864)->find();
